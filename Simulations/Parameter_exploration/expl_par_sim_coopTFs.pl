...
$cpf[0]=5; ## $coopfac
$cpf[1][0]=1; $cpf[1][1]=2; $cpf[1][2]=3; $cpf[1][3]=4; $cpf[1][4]=5; 
...
while($runfl==0)
{
  ...
  $degm=0.1; ## mRNA degradation rate per mRNA molecule per unit time 
  $degp=0.02; ## protein degradation rate per protein moleculer per unit time 
  $coopfac=2.25; ## Division factor for Onrate/Offrate 
...
$ff="Cooperative_TFs/$modno"."_NoiseData.txt";
open(WR1,">$ff") or die; 
...
$ff="Cooperative_TFs/$modno"."_Burst_SizeFreq.txt";
open(WR2,">$ff") or die; 
